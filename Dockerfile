...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.8-1787216480@sha256:4c44b8f1cfbfc36b900216809eeb6ae49f4f7b90fe1d47d66ab6be1cb5ee58d4 AS frontend_build
USER root
WORKDIR /usr/src/app
...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.8-1787216480@sha256:4c44b8f1cfbfc36b900216809eeb6ae49f4f7b90fe1d47d66ab6be1cb5ee58d4 AS backend_build
USER root
WORKDIR /usr/src/app
ADD backend /usr/src/app
RUN npm ci && npm run build

FROM registry.access.redhat.com/ubi9/nodejs-22-minimal:9.8-1787020445@sha256:fc8e8ebdb189d074d6448db56baf78edb4f26e7017dcb1c235bf9420eb028cd1
ARG APP_DIR
ENV SRVDIR="${APP_DIR}"
