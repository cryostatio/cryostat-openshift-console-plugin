...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.8-1777524498 AS frontend_build
USER root
WORKDIR /usr/src/app
...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.8-1777524498 AS backend_build
USER root
WORKDIR /usr/src/app
