...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.7-1776041578 AS frontend_build
USER root
WORKDIR /usr/src/app
...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.7-1776041578 AS backend_build
USER root
WORKDIR /usr/src/app
ADD backend /usr/src/app
RUN npm ci && npm run build

FROM registry.access.redhat.com/ubi9/nodejs-22-minimal:9.7-1776041235
ARG APP_DIR
ENV SRVDIR="${APP_DIR}"
