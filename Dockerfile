...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.7-1770626511 AS frontend_build
USER root
WORKDIR /usr/src/app
...
FROM registry.access.redhat.com/ubi9/nodejs-22:9.7-1770626511 AS backend_build
USER root
WORKDIR /usr/src/app
